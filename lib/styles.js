...
// some kind of parsing bug in styled components doesn't seem to like
// styles inside `:before` blocks `width: 0` is just a filler in this
// case that doesn't parse properly.
