    ...
    <div>
      ...
      <Section size="small">
        <TextContent>
          ...
          <p>
            Silverpond wanted to grow the data science and machine learning community in Melbourne,
            and with this in mind we’ve set up a collaborative workspace in McKillop St right in the
            heart of Melbourne CBD with high speed fibre (and WiFi) and close to great cafes and
            leafy trees!
          </p>
          <p>
          ...
          <p>
            While we’re still finishing the space, why not come trial it for a week for free during
            October/November!
          </p>
