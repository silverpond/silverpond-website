...
class ObjectDetectionDemo extends React.Component {
  ...
  handleUpload = () => {
    ...
    fetch(
      `http://54.66.149.233/multiobject?threshold=${this.state.threshold}`,
      {
        method: 'POST',
        body: formData,
      },
  ...
  render() {
    return (
      <div>
        <MastHead
          title="Deep Learning Object Detector Demo"
          subTitle="Just a wonderful demo!"
        />
        ...
        <Section size="small">
          <p>
            ...
            {' '}
            to build an object detector on
            the
            {' '}
          ...
          <p>
            The detector
            is trained to recognise 20 different types of objects:
          </p>
          <List>
            <li><strong>Person:</strong> person</li>
            <li><strong>Animal:</strong> bird, cat, cow, dog, horse, sheep</li>
            <li>
          ...
          <p>
            If you provide an image containing some of these objects, the network should
            localise them!
          </p>
          <p><em>Note: Please keep images below 2 MB in size.</em></p>
          ...
          <ImageContainer>
            {this.state.image
              ? <Svg
                  viewBox={
                    `0 0 ${this.state.imageWidth} ${this.state.imageHeight}`
                  }
                >
